...
# Load dye data from JSON file
def load_substances():
    path = os.path.join(os.path.dirname(__file__), 'substances.json')
    try:
        with open(path, 'r') as f:
            return json.load(f)
    except Exception as e:
        print(f"Failed to load substances: {e}")
        return {}
...
class DyeCalculator(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # Create horizontal layout for the "Calcolare" and "Reset" buttons
        ...
        # Create horizontal layout for the "Storico" and "Pulisci Storico" buttons
    ...
    def calculate(self, instance):
        try:
            ...
            # Add operation info to history in the required format, including calculated results
    ...
    def show_history(self, instance):
        # Create the ScrollView for the history popup
